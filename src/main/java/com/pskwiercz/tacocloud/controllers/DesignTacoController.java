...
public class DesignTacoController {
    ...
    @ModelAttribute //It will be always added to Model - needed when design form have errors and ingredients must be display again
    ...
    @PostMapping
    public String processDesign(@Valid Taco taco, BindingResult bindingResult) {
